...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
        ec.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
        ec.title('Warning!!')
    ...
    def fill_attendance():
        ...
        global subb
        subb=SUB_ENTRY.get()
        DB_table_name = str(subb + "_" + Date + "_" + Time + "_" + Hour + "_" + Minute + "_" + Second)
        # print(DB_table_name)
        ...
        sql = "CREATE TABLE " + DB_table_name + "(ID INT NOT NULL AUTO_INCREMENT, ENROLLMENT varchar2(100) NOT NULL, NAME VARCHAR2(50) NOT NULL, DATE VARCHAR2(20) NOT NULL, TIME VARCHAR2(20) NOT NULL, PRIMARY KEY (ID));"
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
            ...
            def create_csv():
                ...
                csv_name=r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\\Manually Attendance\\'+ DB_table_name +'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\\Manually Attendance"')
...
def err_screen():
    ...
    sc1.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    sc1.title('Warning!!')
...
def err_screen1():
    ...
    sc2.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    sc2.title('Warning!!')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\\haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite(r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\\TrainingImage\\" + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
            ...
            with open(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read(r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\\TrainingImageLabel\\Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\\haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv(r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                timeStamp = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
                Hour, Minute, Second = timeStamp.split(":")
                fileName = r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\\" + Subject + "_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
                attendance = attendance.drop_duplicates(['Enrollment'], keep='first')
                print(attendance)
                ...
                ##Create table for Attendance
                date_for_DB = datetime.datetime.fromtimestamp(ts).strftime('%Y_%m_%d')
                DB_Table_name = str( Subject + "_" + date_for_DB + "_" + timeStamp + "_" + Hour + "_" + Minute + "_" + Second)
                # print(DB_Table_name)
                import pymysql.connections
                ...
                sql = "CREATE TABLE " + DB_Table_name + "(ID INT NOT NULL AUTO_INCREMENT, ENROLLMENT varchar(100) NOT NULL, NAME VARCHAR(100) NOT NULL, DATE VARCHAR(100) NOT NULL, TIME VARCHAR(20) NOT NULL, PRIMARY KEY (ID));"
                ...
                try:
                    ...
                    # print("success created ansciabs")
                    print(ex)  
    ...
    windo = tk.Tk()
    windo.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\\-------Check atttendance-------"')
...
def admin_panel():
    win = tk.Tk()
    win.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    win.title("LogIn")
    ...
    def log_in():
        ...
        if username == 'root' :
            if password == '':
                ...
                cs = r'C:/Users/sunda/Downloads/Attendace_management_system-master/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
...
def trainimg():
    ...
    try:
        global faces,Id
        faces, Id = getImagesAndLabels(r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\\TrainingImage")
    except Exception as e:
    ...
    try:
        recognizer.save(r"C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\TrainingImageLabel\Trainner.yml")
    except Exception as e:
...
window.iconbitmap(r'C:\\Users\sunda\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
